...
if(wpjam_basic_get_setting('version') < 3.71){
	wpjam_basic_update_setting('version', '3.71');
...
remove_filter( 'get_term_metadata', 'wp_check_term_meta_support_prefilter' );
remove_filter( 'add_term_metadata', 'wp_check_term_meta_support_prefilter' );
remove_filter( 'update_term_metadata', 'wp_check_term_meta_support_prefilter' );
remove_filter( 'delete_term_metadata', 'wp_check_term_meta_support_prefilter' );
remove_filter( 'get_term_metadata_by_mid', 'wp_check_term_meta_support_prefilter' );
remove_filter( 'update_term_metadata_by_mid', 'wp_check_term_meta_support_prefilter' );
remove_filter( 'delete_term_metadata_by_mid', 'wp_check_term_meta_support_prefilter' );
remove_filter( 'update_term_metadata_cache', 'wp_check_term_meta_support_prefilter' );
